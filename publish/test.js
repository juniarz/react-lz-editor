...
var Test = function (_React$Component) {
  ...
  Test.prototype.receiveHtml = function receiveHtml(content) {
  ...
  Test.prototype.receiveMarkdown = function receiveMarkdown(content) {
    console.log("recieved markdown content", content);
  };

  Test.prototype.receiveRaw = function receiveRaw(content) {
    console.log("recieved Raw content", content);
  };

  Test.prototype.onChange = function onChange(info) {
  ...
  Test.prototype.beforeUpload = function beforeUpload(file) {
    console.log("beforeUpload like", file);
  };

  Test.prototype.getSignature = function getSignature(fileName) {
    var now = new Date();
  ...
  Test.prototype.getPolicy = function getPolicy(fileName) {
    var now = new Date();
  ...
  Test.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        null,
        'Readonly demo (use default html format ):'
      ),
      _react2.default.createElement(_index2.default, { readOnly: true, active: true, importContent: this.state.readOnlyContent, cbReceiver: this.receiveHtml, uploadProps: uploadProps })
    );
  };
